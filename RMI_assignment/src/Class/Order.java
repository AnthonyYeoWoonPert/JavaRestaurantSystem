...
public class Order implements Serializable{
    ...
    public Order(String customerID,String customerName,String[] orderItemNo,String[] orderItemName, double[] orderItemPrice, double[] orderItemTotalPrice, int[] orderItemQuantity, int orderTotalQuantity, double orderTotalPrice, String paymentType,double paidAmount, String paymentTime, int indexCounter, String paymentStatus, String orderStatus){
