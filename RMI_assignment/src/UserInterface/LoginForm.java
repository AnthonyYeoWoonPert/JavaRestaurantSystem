...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FBOS Ordering System");
...
//            userID = userID.replaceAll("[^0-9]", ""); 
        ...
        if (user.getRole().equals(Role.CUSTOMER)) {
            CustomerPlaceOrderForm c = new CustomerPlaceOrderForm();
            c.lblUname.setText(user.getUsername());
//            c.lblID.setText(userID);
            c.setVisible(true);
            dispose();
        } else {
