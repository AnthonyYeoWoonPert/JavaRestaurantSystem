...
public class AdminGenerateReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        salesReportTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payment Time", "Customer Name", "Item Name", "Total Quantity", "Total Price", "Paid Amount", "Payment Type"
            }
        ));
        jScrollPane1.setViewportView(salesReportTable);

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 0, 36)); // NOI18N
        jLabel1.setText("Sales Report Table");
    ...
    private void loadTable(){
        try{
            DefaultTableModel model = Client.Object.getReport();
