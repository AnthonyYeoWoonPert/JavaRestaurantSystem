...
public class CustomerCartForm extends javax.swing.JFrame {
    ...
    public CustomerCartForm() {
        ...
        OrderCheckoutButton.setEnabled(false);
        ItemPriceTextField.setEnabled(false);
        ItemNameTextField.setEnabled(false);
        ItemTotalPriceTextField.setEnabled(false);
        refresh();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addComponent(YourShoppingCartLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(YourShoppingCartLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void OrderCheckoutButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrderCheckoutButtonActionPerformed
        try {
            Client.Object.viewOrder(customerID);
    ...
    private void ItemQuantitySpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_ItemQuantitySpinnerStateChanged
        ...
        if(itemQuantity<=0){
            ...
            refresh();
//            ItemQuantitySpinner.setValue(itemQuantity);
        }
        else{
    ...
    private void searchOrderItemLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchOrderItemLabelMouseClicked
        // TODO add your handling code here:
        String searchItem = searchItemTextField.getText().toLowerCase();
        try{
...
//        String customerID = lblID.getText();
    ...
    private void editOrderButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editOrderButtonMouseClicked
        // TODO add your handling code here:
        String itemName = ItemNameTextField.getText();
        double totalPrice = Double.parseDouble(ItemTotalPriceTextField.getText());
        int itemQuantity = Integer.valueOf(ItemQuantitySpinner.getValue().toString());
        System.out.println(totalPrice);

        try {
            if(Client.Object.updateCart(customerID, itemName, itemQuantity, totalPrice)){
...
//        P.lblID.setText(id);
    ...
    private void logOutLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_logOutLabelMouseClicked
        try {
            DerbyDB.backupDatabaseCart("C:\\Users\\User\\Downloads\\RMI_assignment\\backupCart.txt");
            DerbyDB.backupDatabaseCustomerOrder("C:\\Users\\User\\Downloads\\RMI_assignment\\backupCustomerOrder.txt");
            DerbyDB.backupDatabaseItem("C:\\Users\\User\\Downloads\\RMI_assignment\\backupItem.txt");
            DerbyDB.backupDatabaseODSUSER("C:\\Users\\User\\Downloads\\RMI_assignment\\backupODSUSER.txt");
            // Proceed with logout
...
//        P.lblID.setText(id);
    ...
    private void refresh(){
        ...
        ItemQuantitySpinner.setValue((Integer)ItemQuantitySpinner.getValue());
        ItemPriceTextField.setText("");
        ItemTotalPriceTextField.setText("");
        searchItemTextField.setText("");
        
        if (totalOrderPrice >= 1) {
            OrderCheckoutButton.setEnabled(true);
        } else if (totalOrderPrice < 1) {
            OrderCheckoutButton.setEnabled(false);
        }
    }
